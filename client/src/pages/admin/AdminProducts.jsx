...
export default function AdminProducts() {
  ...
  const load = () => api.get('/products?limit=48').then(({ data }) => setProducts(data.data)).catch(() => setProducts(demoProducts)).finally(() => setLoading(false));
  useEffect(() => { load(); }, []);
