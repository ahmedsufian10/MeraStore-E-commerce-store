...
export default function AdminOrders() {
  ...
  useEffect(() => { api.get('/orders').then(({ data }) => { if (!Array.isArray(data)) throw new Error('The API returned an invalid order collection.'); setOrders(data); }).catch(() => setOrders(demoOrders)).finally(() => setLoading(false)); }, []);
