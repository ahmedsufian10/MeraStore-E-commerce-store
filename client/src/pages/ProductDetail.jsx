...
export default function ProductDetail() {
  ...
  useEffect(() => { setLoading(true); api.get(`/products/${id}`).then(({ data }) => setProduct(data)).catch(() => setProduct(demoProducts.find((item) => item._id === id) || demoProducts[0])).finally(() => setLoading(false)); }, [id]);
